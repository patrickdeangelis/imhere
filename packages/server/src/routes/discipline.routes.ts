...
disciplineRouter.put('/update/:id', async (request, response) => {
  try {
    ...
    const disciplineUpdated = await alterDiscipline.execute({
      id,
      discipline,
      description,
      workloader
